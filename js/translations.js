const translations = {
    es: {
        ...
        card_vote_p: "Tú eliges: ¿Duelo 1v1 o Battle Royale? Vota cada semana.",
        ...
        tournaments_list_title: "JUGADORES ALISTADOS:",
        tournaments_no_participants: "No hay jugadores alistados aún.",
        tournaments_btn_request: "SOLICITAR CONFIRMACIÓN",
        tournaments_request_sent: "Solicitud enviada al Administrador.",
    ...
    fr: {
        ...
        card_vote_p: "Vous choisissez : Duel 1v1 ou Battle Royale ? Votez chaque semaine.",
        ...
        tournaments_list_title: "JOUEURS INSCRITS :",
        tournaments_no_participants: "Aucun joueur inscrit pour le moment.",
        tournaments_btn_request: "DEMANDER CONFIRMATION",
        tournaments_request_sent: "Demande envoyée à l'administrateur.",
    ...
    ht: {
        ...
        card_vote_p: "Ou chwazi: Duel 1v1 oswa Battle Royale? Vote chak semèn.",
        ...
        tournaments_list_title: "JWÈ KI ENSKRI:",
        tournaments_no_participants: "Pa gen jwè ki enskri ankò.",
        tournaments_btn_request: "MANDE KONFIMASYON",
        tournaments_request_sent: "Demann voye bay Administratè a.",
    ...
    pt: {
        ...
        card_prizes_link: "Mais info aquí →",
        card_vote_title: "VOTAÇÃO",
        card_vote_p: "Você escolhe: Duelo 1v1 ou Battle Royale? Vote toda semana.",
        ...
        tournaments_list_title: "JOGADORES INSCRITOS:",
        tournaments_no_participants: "Ainda não há jogadores inscritos.",
        tournaments_btn_request: "SOLICITAR CONFIRMAÇÃO",
        tournaments_request_sent: "Solicitação enviada ao Administrador.",
...
async function applyTranslations() {
    ...
    const elements = {
        ...
        'btn-request-admin': 'tournaments_btn_request',
